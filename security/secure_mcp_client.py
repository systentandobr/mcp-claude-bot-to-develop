...
class SecureMCPClient:
    ...
    def _secure_request(self, method, endpoint, data=None):
        ...
        if method.lower() == "get":
            ...
            try:
                ...
                logger.debug(
                    f"Resposta: {response.status_code} - {response.text[:100]}..."
                )
    ...
    def select_repo(self, chat_id, repo_name):
        ...
        data = {"chat_id": chat_id, "repo_name": repo_name}
    ...
    def suggest_modification(self, chat_id, file_path, description, repo_name=None):
        ...
        data = {"chat_id": chat_id, "file_path": file_path, "description": description}
        if repo_name:
            data["repo_name"] = repo_name
    ...
    def apply_modification(self, chat_id, suggestion_id):
        ...
        data = {"chat_id": chat_id, "suggestion_id": suggestion_id}
    ...
    def list_files(self, chat_id, path=""):
        ...
        data = {"chat_id": chat_id, "path": path}
    ...
    def get_file_content(self, chat_id, file_path, args):
        ...
        data = {"chat_id": chat_id, "args": args, "file_path": file_path}
    ...
    def get_tree(self, chat_id, max_depth=2, args=""):
        ...
        data = {"chat_id": chat_id, "args": args, "max_depth": max_depth}
    ...
    def checkout_branch(self, chat_id, branch_name, args):
        ...
        data = {"chat_id": chat_id, "args": args, "branch_name": branch_name}
